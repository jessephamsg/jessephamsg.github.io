...
const statsUpdate = {
    ...
    calculateTaskEnjoymentAvg() {
        ...
        let enjoymentSum = arrayStatsService.getSum(taskArray);
        return enjoymentSum / taskArray.length;
    },
    ...
    getMostEnjoyableTasks() {
        ...
        let taskGroupedByEnjoyment = objectStatsService.groupedByProperty(allTaskObj, 'enjoyment');
    ...
    calculateTeamSizeAvg() {
        ...
        let teamSizeSum = arrayStatsService.getSum(teamSizeArray);
        return teamSizeSum / teamSizeArray.length;
    },
    ...
    getIndustryExperience() {
        ...
        let yearsGroupedByIndustry = objectStatsService.groupedByProperty(allExpObj, 'industry');
